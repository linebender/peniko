...
- Breaking change:  `Blob`, `Font`, and `WeakBlob` have been moved to the new `raw_resource_handle` crate. As part of this move, `Font` has been renamed to `FontData` to match `ImageData`. ([#126][] by [@nicoburns][])
